...
<?php if($user_perm >= 3): ?><button onclick="location.href='/app/editor.php'">Editor Panel</button><?php endif; ?>
<?php if($user_perm >= 8): ?><button onclick="location.href='/reportswizard.php'">Reports Wizard</button><?php endif; ?>
...
if(isset($_GET['view'])){
    ...
    if($gossips){
        ...
        echo "<p style='color:#666;'>No visible intel entries.</p>";
    }
}
