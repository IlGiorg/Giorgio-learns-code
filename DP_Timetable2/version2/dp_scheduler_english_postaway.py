...
def greedy_assignment(students):
    """Greedy algorithm to assign subjects to 3 slots"""
    ...
    # and ensure they are in different slots
    sorted_pairs = sorted(cooccurrence.items(), key=lambda x: -x[1])
    
    # Pre-assign the most problematic subjects
    assigned = {}
...
if __name__ == "__main__":
    # Raw data
    raw_data = """Computer Science;Physics;	Business;
Computer Science;	Spanish;Business;
Biology;Computer Science;	Business;
Computer Science;Environmental Sciences Studies (ESS);	Business;
Computer Science;Biology;	Business;Visual Arts;
Biology;	History;Business;
Chemistry;Physics;	Business;
Biology;	Politics;French;
Physics;Computer Science;	Business;
Biology;Chemistry;	Spanish;
Biology;	GeoPolitics;Psychology (Timetabled Online);
Biology;	Psychology (Timetabled Online);Politics;
Chemistry;Computer Science;	History;
Biology;	Psychology (Timetabled Online);Visual Arts;
Biology;	History;GeoPolitics;
Biology;	French;Business;
Biology;Chemistry;	Spanish;
Physics;Computer Science	Business;"""
    ...
    with open('/Users/giorgio/Documents/GitHub/Giorgio-learns-code/DP_Timetable2/results.html', 'w') as f:
